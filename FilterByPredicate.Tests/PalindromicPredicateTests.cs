...
namespace FilterByPredicate.Tests
{
    ...
    public class PalindromicPredicateTests
    {
        ...
        public int[] Select_PalindromicVerifyTests(int[] source) => new PalindromicPredicate().Select(source);

        [Test]
        public void Select_ArrayIsEmpty_ThrowArgumentException() => Assert.Throws<ArgumentException>(
            () => new PalindromicPredicate().Select(Array.Empty<int>()), "Array cannot be empty.");

        [Test]
        public void Select_ArrayIsNull_ThrowArgumentNullException() => Assert.Throws<ArgumentNullException>(
            () => new PalindromicPredicate().Select(null), "Array cannot be null.");
        ...
        public void Select_PerformanceTest()
        {
            ...
            var actual = new PalindromicPredicate().Select(source);
